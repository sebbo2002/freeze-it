module.exports = function (grunt) {
    ...
    const globalConfig = grunt.file.readJSON('./src/client/config.json');
    ...
    grunt.registerTask('buildConfiguration', function () {
        ...
        const builderPath = path.resolve('./src/client/scripts/configurationBuilder.js');
    ...
    grunt.registerTask('buildFavicons', function () {
        ...
        favicons([
            path.resolve('./src/client/img/favicon.s.png'),
            path.resolve('./src/client/img/favicon.m.png'),
            path.resolve('./src/client/img/favicon.l.png')
    ...
    grunt.registerTask('prepareJS', function () {
        ...
        /* Application */
        {
            const webpackConfig = {
                ...
                entry: {
                    ['app']: `${__dirname}/src/client/js/app.js`
                },
                devtool: 'source-map',
        ...
        Object.entries(instanceConfigs).forEach(([language, config]) => {
            const webpackConfig = {
                mode: grunt.option('develop') ? 'development' : 'production',
                entry: {
                    ['app.config']: `${__dirname}/src/client/js/app.config.js`
                },
                devtool: 'source-map',
                cache: !grunt.option('develop'),
                output: {
        ...
        /* Service Worker */
        {
            const webpackConfig = {
                mode: grunt.option('develop') ? 'development' : 'production',
                entry: {
                    ['serviceworker']: `${__dirname}/src/client/js/serviceworker.js`
                },
                devtool: 'source-map',
                cache: !grunt.option('develop'),
                output: {
    ...
    grunt.registerTask('generateZeptoBuild', function () {
        ...
        const script = spawn('./src/client/scripts/generate-zepto-custom-build.sh', [], {
            cwd: __dirname,
            env: process.env
        });
